    ...
    <div class="container d-flex flex-column flex-grow-1 flex-wrap justify-content-center align-items-center">
        <div class="container pt-3">
            <div class="d-flex gap-3">
                <a class="btn btn-primary" href="{{ route('admin.category.create') }}">اضافة تصنيف جديد
                                ...
                                @foreach ($categorys as $category)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-warning"
                                                href="{{ route('admin.category.update', $category->id) }}">عدل
                                        ...
                                        <td><a href="{{ route('admin.category.delete', $category->id) }}"
