    ...
    <div class="container d-flex flex-column flex-grow-1 flex-wrap justify-content-center align-items-center">
        <div class="container pt-3">
            <div class="d-flex gap-3">
                <a class="btn btn-primary" href="{{ route('admin.admin.create') }}">اضافة مشرف جديد
                                ...
                                @foreach ($admins as $admin)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-warning"
                                                href="{{ route('admin.admin.update', $admin->id) }}">عدل
                                        ...
                                        <td><a href="{{ route('admin.admin.delete', $admin->id) }}"
