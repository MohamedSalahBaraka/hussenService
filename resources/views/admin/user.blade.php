    ...
    <div class="container d-flex flex-column flex-grow-1 flex-wrap justify-content-center align-items-center">
        <div class="container pt-3">
            <div class="d-flex gap-3">
                <a class="btn btn-primary" href="{{ route('admin.chat.user') }}">المحادثات
                ...
                <a class="btn btn-primary" href="{{ route('admin.user.create') }}">اضافة مستخدم جديد
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-warning"
                                                href="{{ route('admin.user.update', $user->id) }}">عدل
                                        ...
                                        <td><a href="{{ route('admin.user.delete', $user->id) }}" class="btn btn-danger">حذف
                                                <svg xmlns="http://www.w3.org/2000/svg" class="bi" width="18"
                                                    height="18" viewBox="0 0 512 512">
                                                    <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                                    <path
