    ...
    <div class="container d-flex flex-column flex-grow-1 flex-wrap justify-content-center align-items-center">
        <div class="container pt-3">
            <div class="d-flex gap-3">
                <a class="btn btn-primary" href="{{ route('provider.services.create') }}">اضافة خدمة جديدة
                            ...
                            <tbody>
                                @foreach ($services as $service)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('provider.addbook', $service->id) }}" class="btn btn-secondary">اضافة حجز
                                        ...
                                        <td><a class="btn btn-warning"
                                                href="{{ route('provider.services.update', $service->id) }}">عدل
                                        ...
                                        <td><a href="{{ route('provider.services.delete', $service->id) }}"
