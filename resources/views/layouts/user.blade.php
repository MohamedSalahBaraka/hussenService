    ...
    <main class="d-flex flex-row">
        <div class="d-flex flex-column flex-shrink-0 bg-light sticky-top" style="width: 4.5rem; height: 100vh">
            ...
            <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                ...
                <li class="nav-item">
                    <a href="{{ route('user.profile') }}" class="nav-link active py-3 border-bottom" aria-current="page"
                        title="الصفحة الشخصية" data-bs-toggle="tooltip" data-bs-placement="right">
                ...
                <li>
                    <a href="{{ route('user.chat') }}" class="nav-link py-3 border-bottom" title="الرسائل"
                        data-bs-toggle="tooltip" data-bs-placement="right">
                        <svg class="bi" width="24" height="24" role="img" aria-label="Home"
                            viewBox="0 0 512 512">
                            <path
                ...
                <li>
                    <a href="{{ route('user.upfate.info') }}" class="nav-link py-3 border-bottom" title="عدل البيانات"
                        data-bs-toggle="tooltip" data-bs-placement="right">
                        <svg class="bi" width="24" height="24" role="img" aria-label="Home"
                            viewBox="0 0 512 512">
                            <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                ...
                <li>
                    <a href="{{ route('user.books') }}" class="nav-link py-3 border-bottom" title="الحجوزات"
                        data-bs-toggle="tooltip" data-bs-placement="right">
                ...
                <li>
                    <a href="{{ route('user.account.delete') }}" class="nav-link py-3 border-bottom" title="حذف الحساب"
                        data-bs-toggle="tooltip" data-bs-placement="right">
                        <svg class="bi" width="24" height="24" role="img" aria-label="Orders"
                            viewBox="0 0 448 512">
                            <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
