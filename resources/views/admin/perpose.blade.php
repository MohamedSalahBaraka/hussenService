    ...
    <div class="container d-flex flex-column flex-grow-1 flex-wrap justify-content-center align-items-center">
        <div class="container pt-3">
            <div class="d-flex gap-3">
                <a class="btn btn-primary" href="{{ route('admin.perpose.create') }}">اضافة غرض جديد
                                ...
                                @foreach ($perposes as $perpose)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-warning"
                                                href="{{ route('admin.perpose.update', $perpose->id) }}">عدل
                                        ...
                                        <td><a href="{{ route('admin.perpose.delete', $perpose->id) }}"
